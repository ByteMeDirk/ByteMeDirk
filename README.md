...
### EDUCATION
:computer: **OBS BSc - 2022 - 2024**\
*Computing*

:telescope: **ADL (Higher Advanced Diplomas) - 2021**
- *Physics I*
- *Statistics*
- *Management*
- *Entrepreneurship*
...
### SKILLS & TECH
Data Engineering, Data Analysis, Business Development, Cloud Computing, ETL, Data Ops, Stakeholder Management, Product Management, 
Big Data, Data Warehousing, Flask (APIs), SQL & NoSQL, Python, Spark, Terraform, Airflow, AWS, Azure, GCP. 
